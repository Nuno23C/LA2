...
def hacker(log):
    # log = log = [("****1234********","maria@mail.pt"), ("0000************","ze@gmail.com"), ("****1111****3333","ze@gmail.com")]
    operacoes = {}
    for operacao in log:
    ...
    # opercaoes = {'ze@gmail.com': ['0000************', '****1111****3333'], 'maria@mail.pt': ['****1234********']}
    ...
    # cartoes = [('00001111****3333', 'ze@gmail.com'), ('****1234********', 'maria@mail.pt')]
